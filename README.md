...
The Love Running is a mini-project. It is designed for learning purposes to be responsive on a difrrent devices, alos by being accecible  making it easy to learn and practice HTML5 and CSS3 components of the so-called trinity of web development building blocks along with JavaScript.
...
-   All Images were introduced by [Code Institute](https://codeinstitute.net)
